...
export class SafariTourServices {
    ...
    public getAllRoles: string = "/Account/GetAllRoles";
    public createRoleUrl: string = "/Account/CreateRole";
    public deleteRoleUrl: string = "/Account/DeleteRole";
    public postRmoveUserFromRole: string = "/Account/RemoveUserFromRole";
    public postAddUserToRole: string = "/Account/AddUserToRole";
    public twitterFeedsUrl: string = "/Home/TwitterProfileFeeds";
    ...
    public getHotelDetailsUrl: string = "/Home/GetHotelDetails";
    public getAllHotelDetailsUrl: string = "/Home/GetAllHotelDetails";
    public hotelPricingUrl: string = "/Home/GetHotelPricing";
    public schedulesPricingsUrl: string = "/Home/GetSchedulesPricing";
    public dealsPricingsUrl: string = "/Home/GetDealsPricing";
    ...
    public updateLocationUrl: string = "/api/Administration/UpdateLocation";
    public postOrUpdateVehicleUrl: string = "/api/Administration/PostVehicle";
    public updateVehicleUrl: string = "/api/Administration/UpdateVehicle";
    public postOrUpdateDealsPricingUrl: string = "/api/Administration/PostDealPricing";
    public updateDealsPricingUrl: string = "/api/Administration/UpdateDealPricing";
    public postOrUpdateLaguagePricingUrl: string = "/api/Administration/PostLaguagePricing";
    public updateLaguagePricingUrl: string = "/api/Administration/UpdateLaguagePricing";
    public updateMealPricingUrl: string = "/api/Administration/UpdateMealPricing";
    public postCreateMealPricingUrl: string = "/api/Administration/PostMealPricing";
    public postOrCreateSchedulesPricingUrl: string = "/api/Administration/PostSchedulesPricing";
    public updateSchedulesPricingUrl: string = "/api/Administration/UpdateSchedulesPricing";
    public postCreateHotelPricingUrl: string = "/api/Administration/PostHotelPricing";
    public postUpdateHotelPricingUrl: string = "/api/Administration/UpdateHotelPricing";
    public updateHotelPricingUrl: string = "/api/Administration/UpdateHotelPricing";
    public postCreateHotelUrl: string = "/api/Administration/PostHotel";
    public updateHotelUrl: string = "/api/Administration/UpdateHotel";
    public getHotelPricingById: string = "/api/Administration/GetHotelPricingById";
    public getHotelLocationByHotelIdUrl: string = "/Home/GetHotelLocationByHotelId"
    public getHotelLocationById: string = "/api/Administration/GetLocationByHotelId";
    public getHotelLocationsUrl: string = "/Home/GetHotelLocations";
    public getHotelAddressById: string = "/api/Administration/GetHotelAddressById";
    public getLaguagePricingById: string = "/api/Administration/GetLaguagePricingById";
    public getMealPricingById: string = "/api/Administration/GetMealPricingById";
    public getDealsPricingById: string = "/api/Administration/GetDealsPricingById";
    public postLoginUrl: string = "/Account/Login";
    public getVerifyLoggedInUser: string = "/Account/VerifyLoggedInUser";
    public getLogoutUrl: string = "/Account/Logout";
    public postRegisterUrl: string = "/Account/Register";
