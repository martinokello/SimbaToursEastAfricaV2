...
import { IAddress, ILocation, SafariTourServices, IHotelBooking } from '../../services/safariTourServices';
...
export class AddLocationComponent implements OnInit {
    ...
    public addLocation(): void {
        let actualResult: Observable<any> = this.safariTourService.PostOrUpdateLocation(this.location);
    ...
    public updateLocation() {
        let actualResult: Observable<any> = this.safariTourService.UpdateLocation(this.location);
        actualResult.map((p: any) => {
