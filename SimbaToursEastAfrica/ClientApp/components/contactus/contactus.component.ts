...
import * as google from '../../../wwwroot/assets/google/googleMaps.js';
...
export class ContactUsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        $(document).ready(function () {
            ...
            $('div#ourContactDetails').html("<div align='center' style='width:240px;margin-top:10px;'><h2>Contact Details</h2></div><div align='center'><b>MartinLayooInc Software House,<br/> 2 St Johns Terrace<br/>Flat 3<br/>London<br/>W10 4RB<br/>email: <a href='mailto:business-enterprise@martinlayooinc.co.uk' >MartinLayooInc.</a><br/>07809773365</div>");
